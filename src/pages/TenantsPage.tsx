    ...
    <div className="mx-auto max-w-2xl px-6 py-16">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Hola {user?.name}, elegí con cuál trabajar</p>
        </div>
        <Button
          variant="ghost"
          onClick={() => {
        ...
        <div className="space-y-3">
          {tenants?.map((tenant) => (
            <button
              ...
              className="flex w-full items-center justify-between rounded-xl bg-white p-5 text-left ring-1 ring-slate-200 transition-shadow hover:ring-brand-400"
            >
            ...
            <Card>
              ...
              >
                ...
                <Field
                  ...
                  htmlFor="tenant-name"
                  hint="Se crea con un workflow por defecto que podés editar después"
                >
                  <Input
                    id="tenant-name"
                    required
